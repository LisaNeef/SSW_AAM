%function plot_singleevent_p_time_U(SSW_set,dtime,hostname,TT,bootstrap)
% plot_singleevent_p_time_U.m
%
% Make a plot of zonal-mean 90N-60N average zonal wind over pressure levels and time, 
...
dtime = 40;
hostname = 'blizzard';
TT = 'SSW of Winter 2009 - Zonal Wind Anomaly';
figH = figure('visible','off');
%---temp inputs------


%% load the polar cap temp fields for this event 
[GG,time,lev] = retrieve_p_time_U_single_event(cdate,dtime,hostname);
...
%---temp-------------
fig_name = 'p_time_U_single_event.png';
pw = 10;
ph = 6;
