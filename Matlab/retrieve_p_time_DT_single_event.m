function [GG,tt,lev] = retrieve_p_time_DT_single_event(cdate,dtime,hostname)
%% retrieve_p_time_DT_single_event.m
%
% This routine retrieves the zonal-mean temp at 60hPa, 
% over pressure and time, for a given SSW event, defined by its central date.
% Code by Lisa Neef, 25 Sep 2012
%
% INPUTS:
